...
// RandomString returns a string of random chaaracters of length n, using randomStringSource
...
// an potentially an error. If the optional last parameter is set to true, then we will not rename
// the files, but will us the original file names.
...
// WriteJSON takes a response status code and arbitrary data and writes json to the cllient
